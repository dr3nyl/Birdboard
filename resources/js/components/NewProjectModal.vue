<template>
    ...
    <modal name="new-project" classes="p-10 bg-card rounded-lg" height="auto">
        ...
        <form @submit.prevent="submit">
            <h1 class="text-2xl font-medium mb-16 text-center ">Let's start something new</h1>
                ...
                <div class="flex-1 mr-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input 
                            ...
                            v-model="form.title"
                            >
                        <span class="text-xs italic text-red-500" v-text="errors.title[0]" v-if="errors.title"></span>
                    ...
                    <div class="mb-4">
                        ...
                        <span class="text-xs italic text-red-500" v-text="errors.description[0]" v-if="errors.description"></span>
